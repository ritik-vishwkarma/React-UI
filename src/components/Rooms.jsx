    ...
    <div className="max-w-[1400px] h-[500px] bg-blue-100 mx-auto my-20 pt-16 lg:mb-[20%] md:mb-[35%] px-4 grid lg:grid-cols-3 gap-4">
      <div className="lg:top-20 relative lg:col-span-1 col-span-2">
        ...
        <p className="pt-4">
          ...
          Lorem, ipsum dolor sit amet consectetur adipisicing elit. Repudiandae atque delectus dolorum. Facilis architecto repellendus dolores dignissimos sed iusto quos assumenda eius doloremque officia. Cumque perferendis molestiae consequuntur labore deleniti a, unde non et quaerat tempora?
          ...
          Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptatum culpa distinctio inventore, error perspiciatis harum optio eius dicta molestias nesciunt laborum excepturi.
        </p>
      </div>
