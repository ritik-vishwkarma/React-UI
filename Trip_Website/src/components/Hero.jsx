      ...
      <div className="absolute top-0 w-full h-full flex flex-col justify-center text-white">
        <div className="md:left-[10%] max-w-[1100px] m-auto absolute p-4">
          ...
          <p className="max-w-[600px] drop-shadow-2xl py-2 text-xl">
            ...
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum tenetur itaque sapiente unde pariatur est, cumque laudantium eveniet quos dicta modi repudiandae nostrum delectus laboriosam quas nam obcaecati ex accusamus nulla aspernatur natus tempore. 
          </p>
